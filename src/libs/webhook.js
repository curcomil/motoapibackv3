      ...
      case "payment_intent.succeeded":
        ...
        try {
          ...
          for (const item of data.items) {
            const productId = item.productId; // Asegúrate de que este campo existe en data.items
            const quantity = item.quantity; // Asegúrate de que este campo existe en data.items
